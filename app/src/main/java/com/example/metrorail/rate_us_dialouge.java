...
public class rate_us_dialouge extends Dialog {

    private float userRate = 0;
    public rate_us_dialouge(@NonNull Context context) {
        super(context);
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_rate_us_dialouge);

        final AppCompatButton rateNowBtn = findViewById(R.id.rateNow);
        final AppCompatButton laterBtn = findViewById(R.id.rateLater);
